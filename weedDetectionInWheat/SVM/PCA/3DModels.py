...
pick = open("weedDetectionInWheat/SVM/PCA/3Dlinear.sav", "wb")
...
pick = open("weedDetectionInWheat/SVM/PCA/3Dpolynomial.sav", "wb")
pickle.dump(modeloPCA, pick)
pick.close()
...
pick = open("weedDetectionInWheat/SVM/PCA/3Drbf.sav", "wb")
pickle.dump(modeloPCA, pick)
pick.close()
