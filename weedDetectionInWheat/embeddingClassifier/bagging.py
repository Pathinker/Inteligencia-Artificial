...
def predicciones(SVM):
    ...
    print(f"Precisión del Voting Bagging Classifier SVM: {precision}")


# Cargar el modelo convolucional

alexnet = load_model("weedDetectionInWheat/CNN/alexnetBagging.keras")
